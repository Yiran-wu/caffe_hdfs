...
int main()
{
	...
	string filename_test_images = "t10k-images-idx3-ubyte";
    ...
    string filename_test_labels = "t10k-labels-idx1-ubyte";
	...
	string save_test_images_path = "test/";
	...
	string save_train_images_path = "train/";
